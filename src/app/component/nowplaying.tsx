  ...
  return (
    ...
    <div className="w-full h-fit flex flex-col items-center">
      ...
      plugins={[
        ...
        <CarouselContent>
          {popular.slice(0, 5).map((movie:any) => (
            <CarouselItem
              key={movie.id}
              id={movie.title}
            ...
            >
              ...
              <div className="flex flex-col py-5 gap-4 lg:w-[20%] md:w-[80%] sm:w-full lg:absolute lg:bottom-10 px-4">
                ...
                <Button
                  className={`w-[145px] h-[40px] border flex items-center gap-2 hover:bg-indigo-500 text-black ${theme === "dark" ? "bg-black text-white" : "bg-white border-black"}`}
